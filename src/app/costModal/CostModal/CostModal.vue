...
<script lang="ts">
  ...
  export default {
    ...
    methods:    {
      ...mapActions('costModal', [
        'increment',
        'decrement',
      ]),
    },
    computed:   {
      ...mapGetters('costModal', ['count', 'incrementPending', 'decrementPending']),
    },
    prefetch:   (options: IPreLoad) => {
      return options.store.dispatch('costModal/increment');
    },
  };
</script>
